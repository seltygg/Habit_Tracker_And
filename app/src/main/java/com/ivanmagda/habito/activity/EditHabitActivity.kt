...
import com.sankalpsikchi.habito.model.ReminderTime
import com.sankalpsikchi.habito.model.ResetFrequency
import com.sankalpsikchi.habito.picker.TimePickerFragment
...
class EditHabitActivity : AppCompatActivity(), TimePickerFragment.OnTimeSetListener {
    ...
    companion object {
        val EDIT_HABIT_RESULT = "com.sankalpsikchi.habito.activities.edit_result"
        val EDIT_HABIT_EXTRA_KEY = "com.sankalpsikchi.habito.activities.edit"
    }
}
